...
def create_app(user_repo, operation_repo, record_repo, random_service):
    app = Flask(__name__)
...
if os.environ.get('CURRENT_ENV'):
    ...
    app = create_app(user_repo, operation_repo, record_repo, random_service)
